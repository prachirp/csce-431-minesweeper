...
public class TestMain extends JFrame {
	...
	public TestMain(int numBombs,int DimX, int DimY)
	{
		xDim = DimX;
		yDim = DimY;
		...
		add(new HexJavaBeginnerGrid(statusBar, xDim, yDim, numBombs,s,r));

		scoreTable sw=new scoreTable(this);
		//sw.run();
    ...
    class LevelActionListener implements ActionListener{
    	...
    	public void actionPerformed(ActionEvent evt){
    		...
    		if(beginner.isSelected() == true){
    			...
    			yDim = 6;
    			numBombs = 10;
    			new TestMain(numBombs,xDim,yDim);
